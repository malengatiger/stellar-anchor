...
public class AccountService {
    ...
    public String retrieveKey(String agentId) throws Exception {
        Agent mAgent = firebaseService.getAgent(agentId);
        if (mAgent == null) {
            throw new Exception("Agent not found");
        }
        String seed = cryptoService.getDecryptedSeed(mAgent.getStellarAccountId());
